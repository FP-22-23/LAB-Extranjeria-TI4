...
* **barrios_residen_personas_de_un_país(registros, país)**: recibe una lista de tuplas de tipo RegistroExtranjería y un país de tipo str, y devuelve una lista con los nombres de los distintos barrios en los que residen personas de la nacionalidad del país dado como parámetro. La lista debe estar ordenada en orden alfabético inverso de los nombres de los barrios.
* **promedio_extranjeros_de_país(registros, país)**:  recibe una lista de tuplas de tipo RegistroExtranjería y el nombre de un país de tipo str, y devuelve el promedio de extranjeros procedentes del país dado como parámetro. En el supuesto de que no haya ningún registro para dicho país, debe devolver None.
